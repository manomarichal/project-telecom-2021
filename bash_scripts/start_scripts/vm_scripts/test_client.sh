...
cp /home/student/Desktop/project-telecom-2021/bash_scripts/start_scripts/student_scripts/client_student.sh /home/student/click-reference/solution/start_click.sh
echo "================= BUILDING CLICK ===================="
